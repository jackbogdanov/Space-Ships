...
public class SettingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View thumb1View = rootView.findViewById(R.id.imageRight);
        thumb1View.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                zoomImageFromThumb(thumb1View, R.mipmap.tutorial_1);
            }
        });

        final View thumb2View = rootView.findViewById(R.id.imageLeft);
        thumb2View.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                zoomImageFromThumb(thumb2View, R.mipmap.tutorial_1);
            }
        });
